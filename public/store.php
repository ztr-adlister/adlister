...
<body class= "meetColor">
    ...
    <div class="container storePage">
        ...
        <div class="row">
            <div class="col-md-4 backGroundBox storeHours">
            ...
            </div> <!-- end col-md-4 storeHours-->  

            <div class="col-md-4 backGroundBox text-center">  
                <div class="storeDetails">
                    <div class="tweetSy">
                        <p>Spatula And Chill With Us Online! Find Us Via These Internet World Wide Web Pages</p>
                        ...
                        <a href="https://www.facebook.com/Spatula-City-49012979044/" target="_blank"><i class="zeefa fa fa-facebook-square fa-5x"></i>
                        <p class="twitterSy">Show Us Your Spatulas...</p>
                        </a>  
                        <a href="https://www.instagram.com/alfredyankovic/?hl=en" target="_blank"><i class="zeefa fa fa-instagram fa-5x"></i>
                        <p class="twitterSy">...And We'll Show You Ours!</p>
                        </a>  
                    </div> <!-- end tweetSy-->
            ...
            <div class="col-md-4 backGroundBox text-center">  
                <div class="rushLimbaugh">
                    <div class="rushLimbaughArticle">
                        ...
                        <a href="http://www.rushlimbaugh.com/daily/2007/08/15/rush_interviews_karl_rove6" target="_blank"><p class="rushText">See what 2 of our flippin-est fans, Rush Limbaugh and Karl Rove, have to say about Spatula City!</p></a>
